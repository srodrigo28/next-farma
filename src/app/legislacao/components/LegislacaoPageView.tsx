...
import { getLegalCategories } from "../data";
import { LegalReferenceItem } from "../types";

function LegalCard({ item }: { item: LegalReferenceItem }) {
  return (
...
export function LegislacaoPageView({ items }: { items: LegalReferenceItem[] }) {
      ...
      <WorkspaceShell items={getDrawerMenu()}>
        <section className="space-y-5 pb-4">
          <section className="rounded-[30px] bg-white/82 p-5 shadow-[0_18px_36px_rgba(15,31,56,0.08)]">
            ...
            <p className="mt-3 text-base leading-7 text-muted">Centralize resoluções, notas técnicas e referências legais relevantes para o dia a dia assistencial.</p>
          </section>
